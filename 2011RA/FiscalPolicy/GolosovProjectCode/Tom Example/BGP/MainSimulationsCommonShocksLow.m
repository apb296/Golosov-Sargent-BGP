...
sHist0 = [sHist0;ones(100,4)]; %4 is because sHist0 is 10000x4 matrix
NumSim = 10100;
...
%Added Low to end of data path
save( [Para.datapath 'SimDataParallelCommonShocksLow.mat'],'sHist',...
